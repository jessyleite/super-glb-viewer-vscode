import { df as Dt, H as Y, aB as aA, dg as QA, cR as v, L as $, ec as Rt, ea as HA, eb as me, dE as XA, dF as hA, dl as nA, bS as z, V as zA, z as X, S as W, l as kt, i as Ft, j as St, M as uA, a2 as j, ds as yt, a3 as we, cO as Gt, dP as De, e8 as Tt, dp as xt, cS as lA, cU as Re, am as DA, ao as Lt, an as Mt, ap as ke, aq as mA, al as qA, aj as Ut, ak as _t, bZ as Nt, y as RA, bX as Ht, bR as Fe, D as qt, Z as EA, dU as Ot, c0 as Se, e2 as Kt, x as ZA, dC as jt, dA as vt, dB as Jt, dT as Pt, dn as kA, G as ye, cv as Yt, O as Wt, e1 as Vt, cY as Xt, d0 as zt, du as Zt, dv as Ge, cT as Te, c4 as Ae, ed as ee, dO as te, dW as ae, C as wA, h as $t, dt as Aa, d2 as xe, cE as ea, cZ as ta, ek as aa, ej as sa, eI as CA, el as ia, d7 as na, d6 as oa, d8 as Le, aA as se, bo as ie, bn as OA, bK as KA, bN as ra, bO as ga, bL as ca, bM as Ia, bj as ne, bh as oe, bi as jA, bA as FA, bw as pA, bv as Ba, bu as Ea, bt as Ca, bs as ba, bq as Me, br as Ue, bb as vA, bc as bA, be as dA, c as rA, U as G, b6 as _e, b5 as Ne, bP as da, de as ha, bl as la, bp as Qa, bk as fa, dZ as pa, eJ as T, d4 as ua, a as re, eK as eA, eL as ma, eM as ge, t as ce, em as fA, a5 as wa, eN as Da, eO as cA, r as Ra, p as ka, o as Fa, N as Sa, ei as ya, dG as Ga } from "./index-BoEfGKHU.js";
import { F as Ta, S as xa } from "./StatsManager-SlY6R26b.js";
import { n as La } from "./index-CzMrpYjo.js";
class Ma extends Dt {
  /**
...
`;
      ...
      let x = 0, D = 0;
      const U = 4 * F, y = new Uint8Array(4), J = new Uint8Array(U);
      let AA = m;
      for (; AA > 0 && D < u.byteLength; ) {
        ...
        for (; P < U && D < u.byteLength; ) {
          ...
          if (L && (q -= 128), (q === 0 || P + q > U) && i(3, "bad scanline data"), L) {
            ...
            J.set(u.subarray(D, D + q), P), P += q, D += q;
        }
        const _ = F;
        for (let L = 0; L < _; L++) {
          let N = 0;
          M[x] = J[L + N], N += F, M[x + 1] = J[L + N], N += F, M[x + 2] = J[L + N], N += F, M[x + 3] = J[L + N], x += 4;
        }
        AA--;
      }
      return M;
      ...
      const M = u[w + 3], x = Math.pow(2, M - 128) / 255;
      m[F + 0] = QA.toHalfFloat(Math.min(u[w + 0] * x, 65504)), m[F + 1] = QA.toHalfFloat(Math.min(u[w + 1] * x, 65504)), m[F + 2] = QA.toHalfFloat(Math.min(u[w + 2] * x, 65504)), m[F + 3] = QA.toHalfFloat(1);
    }, f = new Uint8Array(A);
    f.pos = 0;
...
class Be extends XA {
  ...
  load(A, e, a, t) {
    ...
    if (this.resourcePath !== "")
      ...
      const r = hA.extractUrlBase(A);
      i = hA.resolveURL(r, this.path);
    } else
      i = hA.extractUrlBase(A);
...
class qa {
  ...
  extendMaterialParams(A, e) {
    ...
    if (i.clearcoatFactor !== void 0 && (e.clearcoat = i.clearcoatFactor), i.clearcoatTexture !== void 0 && s.push(a.assignTexture(e, "clearcoatMap", i.clearcoatTexture)), i.clearcoatRoughnessFactor !== void 0 && (e.clearcoatRoughness = i.clearcoatRoughnessFactor), i.clearcoatRoughnessTexture !== void 0 && s.push(a.assignTexture(e, "clearcoatRoughnessMap", i.clearcoatRoughnessTexture)), i.clearcoatNormalTexture !== void 0 && (s.push(a.assignTexture(e, "clearcoatNormalMap", i.clearcoatNormalTexture)), i.clearcoatNormalTexture.scale !== void 0)) {
      ...
      e.clearcoatNormalScale = new zA(o, o);
    }
...
class ja {
  ...
  extendMaterialParams(A, e) {
    ...
    if (!t.extensions || !t.extensions[this.name])
      return Promise.resolve();
    const s = [];
    e.sheenColor = new X(0, 0, 0), e.sheenRoughness = 0, e.sheen = 1;
...
class Ja {
  ...
  extendMaterialParams(A, e) {
    ...
    return e.attenuationColor = new X().setRGB(o[0], o[1], o[2], v), Promise.all(s);
  }
}
class Pa {
  constructor(A) {
...
class Ya {
  ...
  extendMaterialParams(A, e) {
    ...
    return e.specularColor = new X().setRGB(o[0], o[1], o[2], v), i.specularColorTexture !== void 0 && s.push(a.assignTexture(e, "specularColorMap", i.specularColorTexture, W)), Promise.all(s);
  }
}
class Wa {
  constructor(A) {
...
const He = "glTF", IA = 12, Ee = { JSON: 1313821514, BIN: 5130562 };
class es {
  constructor(A) {
    ...
    const t = this.header.length - IA, s = new DataView(A, IA);
    let i = 0;
    for (; i < t; ) {
      ...
      if (i += 4, n === Ee.JSON) {
        const r = new Uint8Array(A, IA + i, o);
...
class ns extends qe {
  interpolate_(A, e, a, t) {
    ...
    return is.fromArray(s).normalize().toArray(s), s;
  }
}
const K = {
  POINTS: 0,
...
class Cs {
  ...
  loadBuffer(A) {
    ...
    return new Promise(function(s, i) {
      a.load(hA.resolveURL(e.uri, t.path), s, void 0, function() {
  ...
  loadAccessor(A) {
    ...
    if (t.bufferView === void 0 && t.sparse === void 0) {
      ...
      return Promise.resolve(new lA(r, i, n));
    }
    const s = [];
    return t.bufferView !== void 0 ? s.push(this.getDependency("bufferView", t.bufferView)) : s.push(null), t.sparse !== void 0 && (s.push(this.getDependency("bufferView", t.sparse.indices.bufferView)), s.push(this.getDependency("bufferView", t.sparse.values.bufferView))), Promise.all(s).then(function(i) {
      ...
      if (E && E !== g) {
        ...
        o === null ? Q = new r(t.count * n) : Q = new r(o, B, t.count * n), f = new lA(Q, n, h);
      if (t.sparse !== void 0) {
        ...
        o !== null && (f = new lA(f.array.slice(), f.itemSize, f.normalized)), f.normalized = !1;
    ...
    const c = Promise.resolve(n).then(function(g) {
      return new Promise(function(B, E) {
        ...
        e.isImageBitmapLoader === !0 && (h = function(Q) {
          const f = new Ae(Q);
          f.needsUpdate = !0, B(f);
        }), e.load(hA.resolveURL(g, s.path), h, void 0, E);
      });
    }).then(function(g) {
      return r === !0 && o.revokeObjectURL(n), V(g, i), g.userData.mimeType = i.mimeType || Bs(i.uri), g;
    }).catch(function(g) {
  ...
  loadMaterial(A) {
    ...
    if (c === yA.BLEND ? (o.transparent = !0, o.depthWrite = !1) : (o.transparent = !1, c === yA.MASK && (o.alphaTest = s.alphaCutoff !== void 0 ? s.alphaCutoff : 0.5)), s.normalTexture !== void 0 && i !== EA && (r.push(e.assignTexture(o, "normalMap", s.normalTexture)), o.normalScale = new zA(1, 1), s.normalTexture.scale !== void 0)) {
      const g = s.normalTexture.scale;
      o.normalScale.set(g, g);
    }
    if (s.occlusionTexture !== void 0 && i !== EA && (r.push(e.assignTexture(o, "aoMap", s.occlusionTexture)), s.occlusionTexture.strength !== void 0 && (o.aoMapIntensity = s.occlusionTexture.strength)), s.emissiveFactor !== void 0 && i !== EA) {
      const g = s.emissiveFactor;
      o.emissive = new X().setRGB(g[0], g[1], g[2], v);
    }
    return s.emissiveTexture !== void 0 && i !== EA && r.push(e.assignTexture(o, "emissiveMap", s.emissiveTexture, W)), Promise.all(r).then(function() {
      const g = new i(o);
  ...
  loadMesh(A) {
    ...
    for (let n = 0, r = i.length; n < r; n++) {
      const c = i[n].material === void 0 ? rs(this.cache) : this.getDependency("material", i[n].material);
      o.push(c);
    }
    return o.push(e.loadGeometries(i)), Promise.all(o).then(function(n) {
      ...
      for (let E = 0, h = c.length; E < h; E++) {
        ...
        Object.keys(b.geometry.morphAttributes).length > 0 && cs(b, s), b.name = e.createUniqueName(s.name || "mesh_" + A), V(b, s), f.extensions && iA(t, b, f), e.assignFinalMaterial(b), g.push(b);
      }
  ...
  _loadNodeShallow(A) {
    ...
    return n && o.push(n), s.camera !== void 0 && o.push(t.getDependency("camera", s.camera).then(function(r) {
      ...
      let c;
      if (s.isBone === !0 ? c = new zt() : r.length > 1 ? c = new kA() : r.length === 1 ? c = r[0] : c = new De(), c !== r[0])
  ...
  _createAnimationTracks(A, e, a, t, s) {
    ...
    const c = t.interpolation !== void 0 ? os[t.interpolation] : Ge, g = this._getArrayFromAccessor(a);
  ...
  _createCubicSplineTrackInterpolant(A) {
    A.createInterpolant = function(a) {
      const t = this instanceof ae ? ns : qe;
...
function de(I, A, e) {
  ...
  return wA.workingColorSpace !== v && "COLOR_0" in a && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${wA.workingColorSpace}" not supported.`), V(I, A), bs(I, A, e), Promise.all(t).then(function() {
    return A.targets !== void 0 ? gs(I, A.targets, e) : I;
  });
}
const ds = (I) => (I.traverse((e) => {
...
class hs {
  ...
  normalize() {
    ...
    const A = ds(this.group), e = A.getCenter(new j()), a = A.getSize(new j());
    let t = 1;
    const s = Math.max(a.x, a.y, a.z);
    s > 0 && (t = CA.maxModelSize / s, this.group.scale.multiplyScalar(t)), this.group.position.sub(e.clone().multiplyScalar(t));
  }
  /**
...
const ls = 0, he = 2, Qs = 1, le = 2, fs = 0, ps = 1, us = 10, ms = 0, Oe = 9, Ke = 15, je = 16, ve = 22, Je = 37, Pe = 43, Ye = 76, We = 83, Ve = 97, Xe = 100, ze = 103, Ze = 109, $e = 122, At = 123, et = 131, tt = 132, at = 133, st = 134, it = 137, nt = 138, ot = 139, rt = 140, gt = 141, ct = 142, It = 145, Bt = 146, Et = 148, Ct = 152, YA = 153, ws = 154, WA = 155, Ds = 156, bt = 157, dt = 158, ht = 165, lt = 166, Qt = 1000054e3, ft = 1000054001, pt = 1000054004, ut = 1000054005, $A = 1000066e3, mt = 1000066004;
class BA {
  constructor(A, e, a, t) {
...
function Rs(I) {
  ...
  const s = t._nextUint32(), i = t._nextUint32(), o = t._nextUint32(), n = t._nextUint32(), r = t._nextUint64(), c = t._nextUint64(), g = 3 * Math.max(e.levelCount, 1) * 8, B = new BA(I, H.length + a, g, !0);
  ...
  if (c <= 0) return e;
  const p = new BA(I, r, c, !0), R = p._nextUint16(), k = p._nextUint16(), u = p._nextUint32(), w = p._nextUint32(), m = p._nextUint32(), F = p._nextUint32(), M = [];
  ...
  const x = r + p._offset, D = x + u, U = D + w, y = U + m, J = new Uint8Array(I.buffer, I.byteOffset + x, u), AA = new Uint8Array(I.buffer, I.byteOffset + D, w), P = new Uint8Array(I.buffer, I.byteOffset + U, m), q = new Uint8Array(I.buffer, I.byteOffset + y, F);
  return e.globalData = { endpointCount: R, selectorCount: k, imageDescs: M, endpointsData: J, selectorsData: AA, tablesData: P, extendedData: q }, e;
}
...
class fe extends XA {
  ...
  _createGeometry(A) {
    const e = new Se();
    A.index && e.setIndex(new lA(A.index.array, 1));
...
class O extends XA {
   ...
   */
  constructor(A) {
    super(A), this.transcoderPath = "", this.transcoderBinary = null, this.transcoderPending = null, this.workerPool = new Fs(), this.workerSourceURL = "", this.workerConfig = null, typeof MSC_TRANSCODER < "u" && console.warn(
...
`);
  ...
  _createTextureFrom(A, e) {
    ...
    return g.minFilter = s[0].mipmaps.length === 1 ? $ : DA, g.magFilter = $, g.generateMipmaps = !1, g.needsUpdate = !0, g.colorSpace = wt(e), g.premultiplyAlpha = !!(c & Qs), g;
  }
  /**
   * @private
  ...
  async _createTexture(A, e = {}) {
    const a = Rs(new Uint8Array(A)), t = a.vkFormat === $A && a.dataFormatDescriptor[0].colorModel === 167;
    if (!(a.vkFormat === ms || t && !this.workerConfig.astcHDRSupported))
      return xs(a);
...
const Ts = /* @__PURE__ */ new Set([rA, vA, dA, bA]), NA = {
  [Ze]: rA,
  [ze]: dA,
  [Xe]: bA,
  [Ve]: rA,
...
async function xs(I) {
  ...
  for (let i = 0; i < I.levels.length; i++) {
    ...
    let g;
    if (I.supercompressionScheme === ls)
      g = c.levelData;
...
function wt(I) {
  ...
  return A.colorPrimaries === ps ? A.transferFunction === le ? W : v : A.colorPrimaries === us ? A.transferFunction === le ? ys : Gs : A.colorPrimaries === fs ? se : (console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${A.colorPrimaries}"`), se);
}
var ue = (function() {
...
class _s {
  ...
  async init(A, e) {
    ...
    if (this.camera = new ye(
      ...
      const i = await import("./three.webgpu-8q7lMjGM.js");
    ...
    this.renderer.setSize(t, s), this.renderer.setPixelRatio(window.devicePixelRatio), this.renderer.autoClear = !0, this.renderer.toneMapping = ce, this.renderer.toneMappingExposure = CA.toneMappingExposure, this.renderer.setClearColor(new X(CA.backgroundColor)), this.renderer.outputColorSpace = W, this.isWebGPU || (this.statsManager = new xa(), this.statsManager.init(A)), this.loader = new Be(), this.dracoLoader = new fe(), this.dracoLoader.setDecoderPath(fA.draco.decoderPath), this.loader.setDRACOLoader(this.dracoLoader), this.loader.setMeshoptDecoder(ue), this.renderer && (this.ktx2Loader = new O(), this.ktx2Loader.setTranscoderPath(fA.three.basis.transcoderPath), this.ktx2Loader.detectSupport(this.renderer), this.loader.setKTX2Loader(this.ktx2Loader)), this.animate();
  }
  resize(A, e) {
    if (A <= 0 || e <= 0) {
  ...
  async loadEnvironment(A) {
    ...
    try {
      ...
      if (t.mapping = wa, this.isWebGPU) {
        ...
        this.environmentTexture = i, e.scene.environment = i, e.scene.environmentIntensity = CA.environmentIntensity;
        const o = this.sides.get(T.RIGHT);
        o && (o.scene.environment = i, o.scene.environmentIntensity = CA.environmentIntensity), t.dispose(), s.dispose();
      }
      if (this._skyboxEnabled && this.environmentTexture)
        for (const [, s] of this.sides)
          s.scene.background = this.environmentTexture;
    } catch (t) {
    ...
    if (this.renderer && A && this.camera)
      try {
        ...
        if (this._comparatorMode && e) {
          const a = this.renderer, t = new zA();
          a.getSize(t);
  ...
  async loadModelToSideInternal(A, e, a) {
    if (a) {
      ...
      }), this.loader = new Be(n), this.dracoLoader = new fe(), this.dracoLoader.setDecoderPath(fA.draco.decoderPath), this.loader.setDRACOLoader(this.dracoLoader), this.loader.setMeshoptDecoder(ue), this.renderer && !this.isWebGPU && (this.ktx2Loader = new O(), this.ktx2Loader.setTranscoderPath(fA.three.basis.transcoderPath), this.ktx2Loader.detectSupport(this.renderer), this.loader.setKTX2Loader(this.ktx2Loader));
    } else this.loader && this.loader.manager;
    const t = this.sides.get(e);
    if (!t) return;
    const s = t.model, i = new hs(t.scene), o = (this.lastLoadId.get(e) || 0) + 1;
