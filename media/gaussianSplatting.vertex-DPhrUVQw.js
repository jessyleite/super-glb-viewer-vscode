import { i as e, s as o, q as i, r as n, t as s, u as l, l as f, v as u, w as d, x as c, y as p } from "./BabylonAdapter-DZR9EaPO.js";
const r = "gaussianSplattingVertexShader", a = `#include<sceneUboDeclaration>
...
`;
e.ShadersStoreWGSL[r] || (e.ShadersStoreWGSL[r] = a);
const x = [o, i, n, s, l, f, u, d, c, p];
for (const t of x)
  e.IncludesShadersStoreWGSL[t.name] || (e.IncludesShadersStoreWGSL[t.name] = t.shader);
const v = { name: r, shader: a };
export {
  v as gaussianSplattingVertexShaderWGSL
};
