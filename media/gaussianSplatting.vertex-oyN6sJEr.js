import { i as e, J as t, K as r, M as n, N as l, O as s, P as f, A as c, Q as d, W as p, X as S, Y as u, Z as _ } from "./BabylonAdapter-DZR9EaPO.js";
const a = "gaussianSplattingVertexShader", i = `#include<__decl__gaussianSplattingVertex>
...
`;
e.ShadersStore[a] || (e.ShadersStore[a] = i);
const m = [t, r, n, l, s, f, c, d, p, S, u, _];
for (const o of m)
  e.IncludesShadersStore[o.name] || (e.IncludesShadersStore[o.name] = o.shader);
const D = { name: a, shader: i };
export {
  D as gaussianSplattingVertexShader
};
