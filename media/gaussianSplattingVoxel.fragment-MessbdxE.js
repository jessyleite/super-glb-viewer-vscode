import { i as o } from "./BabylonAdapter-DZR9EaPO.js";
const e = "gaussianSplattingVoxelPixelShader", t = `var voxel_storage: texture_storage_3d<r8unorm,write>;varying vNormalizedPosition: vec3f;varying vNormalizedCenterPosition: vec3f;varying vAlpha: f32;varying vPatchPosition: vec2f;fn gsVoxelPrngCanonical1d(co: f32)->f32 {return fract(sin(co*91.3458)*47453.5453);}
...
`;
o.ShadersStoreWGSL[e] || (o.ShadersStoreWGSL[e] = t);
const n = { name: e, shader: t };
export {
  n as gaussianSplattingVoxelPixelShaderWGSL
};
