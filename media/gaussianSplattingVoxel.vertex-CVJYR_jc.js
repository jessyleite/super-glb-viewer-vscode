import { i as t, s as i, q as s, v as o } from "./BabylonAdapter-DZR9EaPO.js";
const r = "gaussianSplattingVoxelVertexShader", a = `#include<sceneUboDeclaration>
...
`;
t.ShadersStoreWGSL[r] || (t.ShadersStoreWGSL[r] = a);
const n = [i, s, o];
for (const e of n)
  t.IncludesShadersStoreWGSL[e.name] || (t.IncludesShadersStoreWGSL[e.name] = e.shader);
const u = { name: r, shader: a };
export {
  u as gaussianSplattingVoxelVertexShaderWGSL
};
