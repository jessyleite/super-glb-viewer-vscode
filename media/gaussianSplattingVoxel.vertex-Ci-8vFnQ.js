import { i as a, J as o, K as r, M as n, N as l, W as s } from "./BabylonAdapter-DZR9EaPO.js";
const e = "gaussianSplattingVoxelVertexShader", i = `#include<__decl__gaussianSplattingVertex>
...
a.ShadersStore[e] || (a.ShadersStore[e] = i);
const p = [o, r, n, l, s];
for (const t of p)
  a.IncludesShadersStore[t.name] || (a.IncludesShadersStore[t.name] = t.shader);
const c = { name: e, shader: i };
export {
  c as gaussianSplattingVoxelVertexShader
};
