import { formatBytes as V, MaterialExtension as m, InspectorAPI as te } from "./index-M7_bmiUs.js";
import { SceneGraphNodeType as Le } from "./index-M7_bmiUs.js";
import { eq as n, er as e, es as ne, et as ae, eu as re, ev as le, ew as oe, ex as ce, ey as ie, ez as ue, eA as G, eB as D, eC as j, eD as de, eE as he, eF as pe, eG as me, cv as b, eH as T, a3 as H, cM as Q } from "./index-BoEfGKHU.js";
function xe({ stats: s }) {
  const t = [];
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ e.jsxs("span", { className: "tree-node-icon", role: "img", "aria-label": t.type, children: [
            ...
            (t.type === "node" || t.type === "scene") && (h ? /* @__PURE__ */ e.jsx(ue, {}) : /* @__PURE__ */ e.jsx(G, {})),
            !["mesh", "light", "camera", "armature", "bone", "material", "node", "scene"].includes(t.type) && /* @__PURE__ */ e.jsx(G, {})
          ] }),
...
const F = new Q(), X = new H();
function Ne(s) {
  return X.set(s[0], s[1], s[2], s[3]), F.setFromQuaternion(X, "XYZ"), [
    b.radToDeg(F.x),
    b.radToDeg(F.y),
    b.radToDeg(F.z)
  ];
...
const L = new Q(), Y = new H();
function Te({ node: s, api: t }) {
  const a = s.getTranslation(), l = s.getRotation(), c = s.getScale(), o = [0, 0, 0];
  l && (Y.set(l[0], l[1], l[2], l[3]), L.setFromQuaternion(Y, "XYZ"), o[0] = b.radToDeg(L.x), o[1] = b.radToDeg(L.y), o[2] = b.radToDeg(L.z));
