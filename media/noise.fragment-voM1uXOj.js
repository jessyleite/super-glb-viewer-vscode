...
const o = "noisePixelShader", i = `uniform float brightness;uniform float persistence;uniform float timeScale;varying vec2 vUV;vec2 hash22(vec2 p)
...
`;
e.ShadersStore[o] || (e.ShadersStore[o] = i);
