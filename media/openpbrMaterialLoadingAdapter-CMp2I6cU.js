import { V as r, C as s } from "./BabylonAdapter-CeSNZ_mQ.js";
class o {
  /**
   ...
   */
  constructor(e) {
    this._extinctionCoefficient = r.Zero(), this._material = e;
  }
  /**
  ...
  set transmissionColor(e) {
    e.equals(s.White()) || (this._material.transmissionColor = e);
  }
  /**
...
export {
  o as OpenPBRMaterialLoadingAdapter
};
