import { S as i } from "./BabylonAdapter-CeSNZ_mQ.js";
const e = "selectionPixelShader", f = `#ifdef INSTANCES
...
`;
i.ShadersStoreWGSL[e] || (i.ShadersStoreWGSL[e] = f);
const r = { name: e, shader: f };
export {
  r as selectionPixelShaderWGSL
};
