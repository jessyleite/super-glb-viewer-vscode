import { S as t } from "./BabylonAdapter-CeSNZ_mQ.js";
const e = "selectionOutlinePixelShader", o = `uniform sampler2D maskSampler;uniform sampler2D depthSampler;varying vec2 vUV;uniform vec2 screenSize;uniform vec3 outlineColor;uniform float outlineThickness;uniform float occlusionStrength;uniform float occlusionThreshold;
...
`;
t.ShadersStore[e] || (t.ShadersStore[e] = o);
const i = { name: e, shader: o };
export {
  i as selectionOutlinePixelShader
};
