import { i as t } from "./BabylonAdapter-DZR9EaPO.js";
const e = "selectionOutlinePixelShader", l = `var maskSamplerSampler: sampler;var maskSampler: texture_2d<f32>;
...
`;
t.ShadersStoreWGSL[e] || (t.ShadersStoreWGSL[e] = l);
const r = { name: e, shader: l };
export {
  r as selectionOutlinePixelShaderWGSL
};
