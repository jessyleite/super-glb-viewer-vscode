import { i as e, r as s, aC as o } from "./BabylonAdapter-DZR9EaPO.js";
const t = "fibonacci", a = `fn rcp(x: f32)->f32
{return 1./x;}
...
const c = { name: t, shader: a }, i = "diffusionProfile", l = `uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;
e.IncludesShadersStoreWGSL[i] || (e.IncludesShadersStoreWGSL[i] = l);
const u = { name: i, shader: l }, n = "subSurfaceScatteringPixelShader", f = `#include<helperFunctions>
#include<fibonacci>
...
const d = { name: n, shader: f };
export {
  d as subSurfaceScatteringPixelShaderWGSL
};
