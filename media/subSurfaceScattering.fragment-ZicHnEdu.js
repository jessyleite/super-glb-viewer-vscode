import { i as e, Q as c, aD as s } from "./BabylonAdapter-DZR9EaPO.js";
const r = "fibonacci", a = `#define rcp(x) 1./x
...
const f = { name: r, shader: a }, t = "diffusionProfile", n = "uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];";
e.IncludesShadersStore[t] || (e.IncludesShadersStore[t] = n);
const d = { name: t, shader: n }, o = "subSurfaceScatteringPixelShader", l = `#include<helperFunctions>
#include<fibonacci>
...
e.ShadersStore[o] || (e.ShadersStore[o] = l);
const S = [c, f, s, d];
for (const i of S)
  e.IncludesShadersStore[i.name] || (e.IncludesShadersStore[i.name] = i.shader);
const p = { name: o, shader: l };
export {
  p as subSurfaceScatteringPixelShader
};
