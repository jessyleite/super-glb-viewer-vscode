import { i } from "./BabylonAdapter-DZR9EaPO.js";
const e = "volumetricLightingBlendVolumePixelShader", o = `varying vec2 vUV;uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform mat4 invProjection;uniform vec2 outputTextureSize;
...
`;
i.ShadersStore[e] || (i.ShadersStore[e] = o);
const t = { name: e, shader: o };
export {
