import { i as e, a1 as r, K as n } from "./BabylonAdapter-DZR9EaPO.js";
const t = "volumetricLightingRenderVolumePixelShader", o = `#include<__decl__sceneFragment>
...
`;
e.ShadersStore[t] || (e.ShadersStore[t] = o);
const a = [r, n];
for (const i of a)
  e.IncludesShadersStore[i.name] || (e.IncludesShadersStore[i.name] = i.shader);
const l = { name: t, shader: o };
export {
  l as volumetricLightingRenderVolumePixelShader
};
